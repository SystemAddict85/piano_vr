...
public class LevelManager : SimpleSingleton<LevelManager>
{
    ...
    public void ShowMenu()
    {
        ...
        if (newGame)
        {
            ...
            currentEventSystem.SetSelectedGameObject(startButton);
        }
        else
        {
            startButton.SetActive(false);
            replayStageButton.SetActive(true);
            currentEventSystem.SetSelectedGameObject(replayStageButton);
        }
    }
    ...
    public void ShowStageSelect()
    {
        ...
        //currentEventSystem.firstSelectedGameObject = stageSelectCanvas.GetChild(0).gameObject;
        currentEventSystem.SetSelectedGameObject(stageSelectCanvas.GetChild(0).gameObject);
    }
