...
public class EnemyManager : SimpleSingleton<EnemyManager>
{
    ...
    {
        public GameObject DestroyEnemyCollier;
        public GameObject ShowReticleCollider;
        public GameObject NextEnemyCollider;
        public GameObject Objective;
        public ShipReticle ShipReticle;
    }

    [Serializable]
    public class IdleBoxPathSettings
    {
    ...
    [Header("IdleBox Settings")]
    [SerializeField]
    IdleBoxPathSettings idleBoxPathSettings;
    ...
    public void ApplyEnemySettings(ref Enemy e)
    {
        e.m_spawnNextEnemyCollider = enemySettings.NextEnemyCollider;
        e.m_destroyCollider = enemySettings.DestroyEnemyCollier;
        e.m_showReticleCollider = enemySettings.ShowReticleCollider;
        e.shipReticle = enemySettings.ShipReticle;
        e.m_objective = enemySettings.Objective;

        //return e;
    }

    public void ApplyIdleBoxSettings(ref IdlePath bx)
    {
        bx.speed = idleBoxPathSettings.speed;
        bx.buff = idleBoxPathSettings.buff;
        bx.transform.localScale = idleBoxPathSettings.scale;
    }
