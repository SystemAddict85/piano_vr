...
public class GameManager : SimpleSingleton<GameManager>
{
    ...
    //string m_InstructionsPrompt = "Select with touchpad\nConfirm with trigger\n? to go back";
    [HideInInspector]
    ...
    int PlayerHealth
    {
        ...
        set
        {
            ...
            if (playerHealth <= 0)
            {
                ...
                LevelManager.Instance.gameOverText.SetActive(true);
                StopSpawning();
            }
        }
    }
    ...
    {
        //StartSpawning();
        StopSpawning(); // make sure game is clear initially
        EnemyManager.Instance.tracker.trackingMonitor.PrintTrackingToScreenEmpty("");
        //EnemyManager.Instance.tracker.trackingMonitor.PrintTrackingToScreenEmpty(m_InstructionsPrompt);
    }
    ...
    public void StopSpawning()
    {
        ...
        EnemyManager.Instance.shipReticle.Activate(false);
    ...
    {
        isGameActive = true;
        EnemyManager.Instance.shipReticle.Activate(true);
        PlayerHealth = 100;
        CheckPoolAndSpawn();
        readyToSpawn = true;
        FirstEnemy();
        LevelManager.Instance.nextStageButton.SetActive(true);
        LevelManager.Instance.gameOverText.SetActive(false);
    }
    ...
    public void CheckGameState(bool hasPassedThreshold)
    {
        ...
        {
            Debug.Log("hasPassedThreshhold: " + hasPassedThreshold);
